...
$LANG['clientmessage'] = '客户留言';
$LANG['contactus'] = '联系我们';
$LANG['mail_setting'] = '设置';
$LANG['subscribe'] = '客户订阅';
$LANG['address_setting'] = '公司地址';
$LANG['add_location'] = '添加地址';
$LANG['release_point_management'] = '发布点管理';
$LANG['poster'] = '广告';
$LANG['news_types'] = '文章分类';
$LANG['addnewstypes'] = '增加分类';
$LANG['tec_support'] = '技术支持';
$LANG['reseller'] = 'Reseller';
$LANG['reseller'] = 'Reseller';
$LANG['FAQ'] = 'FAQ';
$LANG['faq_add'] = '添加';
$LANG['contact_infos'] = '联系方式';
$LANG['twitter_update'] = 'twitter更新';
?>