...
//来源
define('HTTP_REFERER', isset($_SERVER['HTTP_REFERER']) ? addslashes(remove_xss($_SERVER['HTTP_REFERER'])) : '');
...
define('JQUERY_FILE_UPLOAD',WEB_PATH.'statics/plugin/jquery_file_upload/');

//手机端js 路径
define('MOBILE_JS_PATH',WEB_PATH.'statics/mobile/js/');
//手机端css 路径
define('MOBILE_CSS_PATH',WEB_PATH.'statics/mobile/css/');
//手机端img 路径
define('MOBILE_IMG_PATH',WEB_PATH.'statics/mobile/images/');
//手机端pic 路径
define('MOBILE_PIC_PATH',WEB_PATH.'statics/mobile/pic/');
//手机端fonts 路径
define('MOBILE_FONTS_PATH',WEB_PATH.'statics/mobile/fonts/');
