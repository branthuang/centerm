                    ...
                    foreach ($list as $v):
                        ...
                        <tr>
                            ...
                            <td><a href="javascript:view(<?php echo $v['id']; ?>)">查看</a> 
                                | 
                                <a href="index.php?m=contact&c=contact&a=mail_send&type=1&id=<?php echo $v['id'] ?>" title="邮件重新发送">邮件重发</a>
                                | 
                                <a href="index.php?m=contact&c=contact&a=delete&id=<?php echo $v['id'] ?>" title="删除不可恢复" onclick="if(!confirm('删除不可恢复。确认删除？')){return false;}">删除</a>
                            </td>
                        </tr>
                        <?php
                    endforeach;
...
<script type="text/javascript">
    function view(id) {
        window.top.art.dialog({title: '查看', id: 'edit', iframe: 'index.php?m=contact&c=contact&a=view&id=' + id, width: '500px', height: '400px'});
    }
