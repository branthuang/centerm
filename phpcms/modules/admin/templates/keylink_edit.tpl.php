...
<script type="text/javascript">
	$(function(){
		...
		$("#url").formValidator({onshow:"<?php echo L('input_siteurl');?>",onfocus:"<?php echo L('input_siteurl');?>"}).inputValidator({min:1,onerror:"<?php echo L('input_siteurl');?>"}).regexValidator({regexp:"^http:|https:",onerror:"<?php echo L('copyfrom_url_tips');?>"});
