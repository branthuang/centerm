...
'upload_url' => 'http://127.0.0.1:9065/uploadfile/', //附件路径
'attachment_stat' => '1',//是否记录附件使用状态 0 统计 1 统计， 注意: 本功能会加重服务器负担

'js_path' => 'http://127.0.0.1:9065/statics/js/', //CDN JS
'css_path' => 'http://127.0.0.1:9065/statics/css/', //CDN CSS
'img_path' => 'http://127.0.0.1:9065/statics/images/', //CDN img
'app_path' => 'http://127.0.0.1:9065/',//动态域名配置地址
...
'phpsso' => '1',	//是否使用phpsso
'phpsso_appid' => '1',	//应用id	
'phpsso_api_url' => 'http://127.0.0.1:9065/phpsso_server',	//接口地址
