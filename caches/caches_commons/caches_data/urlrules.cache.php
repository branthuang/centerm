...
return array (
  ...
  31 => 'events-{$catid}-{$page}.html',
  32 => 'products-{$catid}-{$page}.html',
  33 => 'case-{$catid}-{$page}.html',
  34 => 'community-{$catid}-{$page}.html',
  35 => 'faq-{$catid}-{$page}.html',
  36 => 'download-{$catid}-{$page}.html',
);
?>