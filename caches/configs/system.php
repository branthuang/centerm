...
'cookie_pre' => 'lOTNv_', //Cookie 前缀，同一域名下安装多套系统时，请修改Cookie前缀
...
'upload_url' => 'http://127.0.0.1:8023/uploadfile/', //附件路径
'attachment_stat' => '1',//是否记录附件使用状态 0 统计 1 统计， 注意: 本功能会加重服务器负担

'js_path' => 'http://127.0.0.1:8023/statics/js/', //CDN JS
'css_path' => 'http://127.0.0.1:8023/statics/css/', //CDN CSS
'img_path' => 'http://127.0.0.1:8023/statics/images/', //CDN img
'app_path' => 'http://127.0.0.1:8023/',//动态域名配置地址
...
'gzip' => 1, //是否Gzip压缩后输出
'auth_key' => 'nC2C9MBH8brXMRWZwK7K', //密钥
'lang' => 'zh-cn',  //网站语言包
...
'phpsso' => '1',	//是否使用phpsso
'phpsso_appid' => '1',	//应用id	
'phpsso_api_url' => 'http://127.0.0.1:8023/phpsso_server',	//接口地址
'phpsso_auth_key' => '5XaDHrVHzhXHftDRkQDY4bv4YNL02y8D', //加密密钥
