<?php defined('IN_PHPCMS') or exit('No permission resources.'); ?><div class="boxbg mtop10">
    <div class="subscribe">
        <div class="h5_16 gray">Subscribe to news</div>
        ...
        <div class=" mtop10">
            <div class="input-group">
                ...
                <span class="input-group-addon" style="padding:0"><button class="btn btn-default" style="border:none; background:none" type="button" data-toggle="modal" data-target="#myModal" id="subscribe_to_email2">Subscribe</button></span>
            </div>
        </div>
    </div>
</div> 
